...
src_install() {
	...
	make_desktop_entry penumbra-overture "Penumbra: Overture" \
		penumbra-overture.png || die "make_desktop_entry overture"
	make_desktop_entry penumbra-blackplague "Penumbra: Black Plague" \
		penumbra-blackplague.png || die "make_desktop_entry black plague"
	make_desktop_entry penumbra-requiem "Penumbra: Requiem" \
		penumbra-requiem.png || die "make_desktop_entry requiem"
