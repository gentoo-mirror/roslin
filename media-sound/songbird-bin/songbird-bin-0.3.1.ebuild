...
MY_PN="${PN/songbird-bin/Songbird}"
#MY_PV1="$(replace_version_separator 2 '' ${PV})"
#MY_PV="$(replace_version_separator 1 '_' ${MY_PV1})"
S="${WORKDIR}/${MY_PN}"

DESCRIPTION="A multimedia player, inspired by iTunes"
HOMEPAGE="http://www.songbirdnest.com/"
SRC_URI="x86? ( http://download.songbirdnest.com/installer/linux/i686/${MY_PN}_${PV}_linux-i686.tar.gz )
	amd64? ( http://download.songbirdnest.com/installer/linux/x86_64/${MY_PN}_${PV}_linux-x86_64.tar.gz ) "
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~x86 ~amd64"
